...
CHAT = {
    "relationship": "The other person is my partner; from=me is what I sent, from=other is what they sent",
    "messages": [
        {"from": "other", "text": "Do you remember what I'm doing next week?"},
        {"from": "me", "text": "Yeah, I remember"},
        {"from": "other", "text": "Then tell me"},
    ],
    "latest_from": "other",
}

BACKGROUND = (
    "Relationship: partner, together 3 years. "
    "Contact notes: she has a job interview at a design company in Shanghai next Wednesday and is nervous about it. "
    "Knowledge base hits: she has zero tolerance for lateness; she doesn't drink coffee."
)
